...
int WinMain(){ //A função main teve de ser alterada pra WinMain pois conflitava com a main do SDL
    ...
    */
    ...
    DefineObj3DIlum(1.0, 1.0, 1.0, 1.0, &scene->array_objs[0]);
    DefineObj3DIlum(1.0, 1.0, 1.0, 1.0, &scene->array_objs[1]);
    DefineObj3DIlum(1.0, 1.0, 1.0, 1.0, &scene->array_objs[2]);
    DefineObj3DIlum(1.0, 1.0, 1.0, 1.0, &scene->array_objs[3]);
    DefineObj3DIlum(1.0, 1.0, 1.0, 1.0, &scene->array_objs[4]);
    DefineObj3DIlum(1.0, 1.0, 10.0, pow(2, 6), &scene->array_objs[5]);
    DefineObj3DIlum(1.0, 1.0, 10.0, pow(2, 6), &scene->array_objs[6]);
    DefineObj3DIlum(1.0, 1.0, 1.0, 1.0, &scene->array_objs[7]);
    DefineObj3DIlum(1.0, 1.0, 1.0, 1.0, &scene->array_objs[8]);
    DefineObj3DIlum(1.0, 1.0, 1.0, 1.0, &scene->array_objs[9]);
    DefineObj3DIlum(1.0, 1.0, 1.0, 1.0, &scene->array_objs[10]);
    DefineObj3DIlum(1.0, 1.0, 1.0, 1.0, &scene->array_objs[11]);
    DefineObj3DIlum(1.0, 1.0, 1.0, 1.0, &scene->array_objs[12]);
    DefineObj3DIlum(1.0, 1.0, 1.0, 1.0, &scene->array_objs[13]);
    DefineObj3DIlum(1.0, 1.0, 1.0, 1.0, &scene->array_objs[14]);
    DefineObj3DIlum(1.0, 1.0, 1.0, 1.0, &scene->array_objs[15]);
    DefineObj3DIlum(1.0, 1.0, 1.0, 1.0, &scene->array_objs[16]);
    DefineObj3DIlum(1.0, 1.0, 1.0, 1.0, &scene->array_objs[17]);
    DefineObj3DIlum(1.0, 1.0, 1.0, 1.0, &scene->array_objs[18]);
    DefineObj3DIlum(1.0, 1.0, 1.0, pow(2, 6), &scene->array_objs[19]);
